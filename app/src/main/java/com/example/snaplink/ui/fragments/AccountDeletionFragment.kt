...
import com.example.snaplink.network.DeleteAccountRequest
...
class AccountDeletionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_account_deletion, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnConfirm = view.findViewById(R.id.btnConfirmDelete)
    ...
    private fun deleteAccount() {
        ...
        ApiClient.api.deleteAccount(DeleteAccountRequest(password, reason))
            .enqueue(object : Callback<SimpleApiResponse> {
                override fun onResponse(call: Call<SimpleApiResponse>, response: Response<SimpleApiResponse>) {
                    ...
                    if (response.isSuccessful) {
                        ...
                        val msg = response.errorBody()?.string() ?: "Failed to delete"
